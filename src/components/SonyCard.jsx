...
const SonyCard = ({ sony }) => {
    const { brandName,_id, name, type, img, rating, price, shortDescription } = sony;
    return (
        <div>
                    ...
                    <div className="flex items-center justify-between mb-3">
                        <Link to={`/details/${_id}`}>
                            <div className="form-control mt-6">
                                <button className="text-xl text-white px-7 lg:px-16 py-2 font-bold bg-[#16a34a] hover:bg-blackLink  rounded">Details</button>
                            </div>
                        </Link>
                        <div>
                            <div className="form-control mt-6">
